...
s1=e1.samples.create( :examination_id => 1, :title => 'がん検診', :define_at => '2015/4/3 10:40' )
s1.sample_metadata_numerical.create( :predicate_numerical => '睡眠時間', :value => '10003')


p2=Project.create( :alias => '身長×悪玉コレステロール003', :title => 'タイトル003', :description => 'プロジェクトの説明', :publication => 'Ver001')
e2=p2.examinations.create( :project_id => 2)
s2=e2.samples.create(  :title => 'がん検診', :define_at => '2015/4/3 10:40' )
s3=e2.samples.create(  :title => '健康診断', :define_at => '2015/5/7 10:40' )
s2.sample_metadata_numerical.create( :predicate_numerical => '大腸菌', :value => '13.5' )
